...
<p><img src="filessharepointsetting.jpg"></p>
...
<p><img src="filesremotedatabase.jpg"></p>The workaround was to specify 127.0.0.1 as the name of the server, rather than RESEARCH (my local machine name)