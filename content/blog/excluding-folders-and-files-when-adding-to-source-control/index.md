...
<img style="display: block; max-width: 100%; height: auto; margin-bottom: 1rem; border: 1px solid black; box-shadow: 2px 2px 10px rgba(0,0,0,0.5);" title="image" src="image_6.png" alt="image" width="546" height="151" border="0" />
...
<img style="display: block; max-width: 100%; height: auto; margin-bottom: 1rem; border: 1px solid black; box-shadow: 2px 2px 10px rgba(0,0,0,0.5);" title="image" src="image_11.png" alt="image" width="388" height="166" border="0" />

Exit and re-run Visual Studio and see that the defaults are different now (no *.dll anymore):

<img style="display: block; max-width: 100%; height: auto; margin-bottom: 1rem; border: 1px solid black; box-shadow: 2px 2px 10px rgba(0,0,0,0.5);" title="image" src="image_12.png" alt="image" width="550" height="47" border="0" />
